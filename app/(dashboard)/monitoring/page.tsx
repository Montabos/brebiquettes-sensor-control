...
import { getMonitoringData } from "@/lib/queries";
import type { DataQualityResult, PipelineRun } from "@/lib/types";

export default async function MonitoringPage() {
  let data: {
    runs: PipelineRun[];
    deadLetters: Array<{ id: string; rejection_reason: string; rejected_at: string }>;
    quality: DataQualityResult[];
  } = { runs: [], deadLetters: [], quality: [] };
  let dbError = false;
